...
if (isset($_POST['ok'])) {
    ...
    if ($validador->contraseña_valida()) {
        $usuario_modificado = repositorioUsuario::actualizarContraseña(password_hash($validador->getContraseña(), PASSWORD_DEFAULT), $_GET['idUs'], Conexion::obtener_conexion());
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <a type="button" class="btn btn-primary ml-auto" href="<?php echo RUTA_LOGIN ?>" >X</a>
            </div>
