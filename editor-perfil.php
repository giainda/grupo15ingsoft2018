...
if (isset($_POST['enviar'])) {
    ...
    if ($validador->editor_valido()) {
        if ($usuario->getCodigo_tarjeta() != 0) {
            ...
            $usuario_modificado = RepositorioUsuario :: actualizarInfo($validador->obtener_nombre(), $validador->obtener_apellido(), 0, $_SESSION['id_usuario'], Conexion::obtener_conexion());
        }
        ?>
                ...
                <div class="card-heading">
                    ...
                    <div class="card-body ">
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <a  href="<?php
                        echo RUTA_INTRODUCCION_CONTRASEÑA?>">Cambiar </a>
                        </div>
                        </div>
                        </div>
                        </div>
