...
if (isset($_POST['enviar'])) {
    ...
    if ($validador->registro_valido()) {
        $viajeNue = new Viaje($viaje->getId(), $_SESSION['id_usuario'], $viaje->getPatente(), '', $new, $viaje->getInicio(), $viaje->getDestino(), $viaje->getAsientos(), $viaje->getPrecio(), $viaje->getDescripcion(), 2, 1, $viaje->getDuracion(),0);
        RepositorioViaje::editarViaje(Conexion::obtener_conexion(),$viajeNue);       
        Redireccion::redirigir(RUTA_EDITOR_VIAJE_MULTIPLE."?idVi=".$viaje->getId());
    }
}
?>
            ...
            <div class="card text-center">
                <div class="card-body">
                    <form role="form" method="post" >
                        ...
                        <input type="date" name="fecha" class="form-control" value="<?php echo $valores[0]?>">
                              
                              <?php

                          }
?>
                        <button type="submit"class="btn botoncss" name="enviar" onclick="location.href ='editor-fecha.php';" >Editar</button>       
