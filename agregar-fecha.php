...
if(isset($_POST['enviar'])){
   ...
   if($validador ->registro_valido()){
       $viajeNue=new Viaje('',$_SESSION['id_usuario'],$viaje->getPatente(),'',$new,
       $viaje -> getInicio(),$viaje-> getDestino(),$viaje -> getAsientos(),$viaje->getPrecio(),
       $viaje->getDescripcion(),2,1,$viaje -> getDuracion());
